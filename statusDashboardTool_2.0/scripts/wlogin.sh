...
function error_exit #Exits script in case of failure
{
    ...
    echo "" #new row
    echo "USAGE: ./wlogin.sh [USER_NAME] [UPLOAD_TYPE (batch, empty]"
    exit 1
}
#----------------------------------------------------------------------
