...
### Log
echo "- Info: $LINENO: $PROGNAME: START Logging IN ... "
...
RESPONSE=`xmllint --xpath "//loginReturn/text()" $T_HOME/logs/messages/responseLogin.xml`

echo "- Info: $LINENO: $PROGNAME: Loggin finished with state: $RESPONSE"
