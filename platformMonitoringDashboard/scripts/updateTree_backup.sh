...
CHANGE_FLAG=$(grep -c green $T_HOME/data/readable_responseGetPage_$TREE_PAGE.xml)
}
...
echo "Page Name is $PARENT_PAGE_NAME"
...
if [ $STATE == "DOWN" ]; then
    ...
    echo "State is: $STATE. Keepink state."
fi
