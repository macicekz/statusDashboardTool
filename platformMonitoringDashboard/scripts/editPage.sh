...
case $1 in
1)  COLOUR_NA1=`cat $T_HOME/data/htmlCharsConvert_responseGetPage_$PAGE.xml | awk -F $'"colour">' '{print  $3 }' | awk -F $'<' '{print $1}'`
echo "State of NA1  in getColour is: $COLOUR_NA1"
;;
2)COLOUR_EU1=`cat $T_HOME/data/htmlCharsConvert_responseGetPage_$PAGE.xml | awk -F $'"colour">' '{print  $4 }' | awk -F $'<' '{print $1}'`
echo "State of EU1 in getColour  is: $COLOUR_EU1"
;;
3)COLOUR_NA2=`cat $T_HOME/data/htmlCharsConvert_responseGetPage_$PAGE.xml | awk -F $'"colour">' '{print  $5 }' | awk -F $'<' '{print $1}'`
...
case $1 in
1)  STATE_NA1=`cat $T_HOME/data/htmlCharsConvert_responseGetPage_$PAGE.xml | awk -F $'"title">' '{print  $3 }' | awk -F $'<' '{print $1}'`
echo "State of NA1  in getState is: $STATE_NA1"
;;
2)STATE_EU1=`cat $T_HOME/data/htmlCharsConvert_responseGetPage_$PAGE.xml | awk -F $'"title">' '{print  $4 }' | awk -F $'<' '{print $1}'`
echo "State of EU1 in getState  is: $STATE_EU1"
;;
3)STATE_NA2=`cat $T_HOME/data/htmlCharsConvert_responseGetPage_$PAGE.xml | awk -F $'"title">' '{print  $5 }' | awk -F $'<' '{print $1}'`
